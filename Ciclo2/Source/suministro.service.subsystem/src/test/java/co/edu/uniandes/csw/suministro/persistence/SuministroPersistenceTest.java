...
public class SuministroPersistenceTest {
	...
	public void createSuministroTest(){
		...
		SuministroDTO result=suministroPersistence.createSuministro(dto);
	...
	public void getSuministrosTest(){
		List<SuministroDTO> list=suministroPersistence.getSuministros();
		Assert.assertEquals(list.size(), data.size());
        for(SuministroDTO dto:list){
        	boolean found=false;
	...
	public void getSuministroTest(){
		...
		SuministroDTO dto=suministroPersistence.getSuministro(entity.getId());
	...
	public void deleteSuministroTest(){
		SuministroEntity entity=data.get(0);
		suministroPersistence.deleteSuministro(entity.getId());
	...
	public void updateSuministroTest(){
		...
		suministroPersistence.updateSuministro(dto);
